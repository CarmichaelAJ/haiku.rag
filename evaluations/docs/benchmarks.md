...
|----------------------|------------|-----------------------------|----------|------------------------------|
| `qwen3-embedding:4b` | 256        | `o4-mini-2025-04-16` - no thinking | 0.74     | plain text, `chunk-radius=0` |
| `qwen3-embedding:4b` | 256        | `o4-mini-2025-04-16` - thinking    | 0.79     | html, `chunk-radius=2`       |
| `qwen3-embedding:4b` | 256        | `o4-mini-2025-04-16` - thinking    | 0.80     | html, `chunk-radius=2`, reranker=`mxbai-rerank-base-v2` |
